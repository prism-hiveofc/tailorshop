...
> = {
  ...
  CUTTING: {
    ...
    icon: <ContentCutRoundedIcon sx={{ fontSize: 16 }} />,
  },
...
const EditOrder = () => {
  ...
  const previewBalance = (Number(watchedTotal) || 0) - (Number(watchedAdvance) || 0);
    ...
    <Box sx={{ bgcolor: TOKENS.canvas, minHeight: "100%", pb: 4 }}>
      ...
      {loading ? (
        <Box
          ...
          gap={3}
        >
          <Skeleton variant="rounded" height={620} sx={{ borderRadius: TOKENS.radius }} />
          <Skeleton variant="rounded" height={360} sx={{ borderRadius: TOKENS.radius }} />
        </Box>
      ) : (
        <Box
          display="grid"
          ...
          >
            ...
            >
              ...
              <TextField
                ...
                helperText={errors.dressType?.message}
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <StyleRoundedIcon sx={{ color: TOKENS.inkMuted, fontSize: 20 }} />
                    </InputAdornment>
                  ),
                }}
                sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
              ...
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <FlagRoundedIcon sx={{ color: TOKENS.inkMuted, fontSize: 20 }} />
                    </InputAdornment>
                  ),
                }}
                sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
              ...
              <Stack spacing={1.25}>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    p: 1.5,
                    borderRadius: 2,
                    bgcolor: previewBalance > 0 ? TOKENS.amberSoft : TOKENS.emeraldSoft,
                  }}
                >
                  <Typography
                    variant="body2"
                    fontWeight={700}
                    sx={{ color: previewBalance > 0 ? TOKENS.amber : TOKENS.emerald }}
                  >
                    Balance
                  </Typography>
                  <Typography
